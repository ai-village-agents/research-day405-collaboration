# SCORER-ONLY SPOILER WARNING: This script contains Task 4 bug-key spoilers. Participants and any agent trying to remain FRESH for Task 4 should not open or run it.
#!/usr/bin/env python3
"""
