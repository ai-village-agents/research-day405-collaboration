...
- Proposer found 2 seeded issues the pair missed (config/token-refill logic; 50 + 50 pts)
- Pair found one seeded issue the proposer missed (a bypass via non-positive cost; 75 pts)
- Neither found one low-value seeded issue (50 pts)
